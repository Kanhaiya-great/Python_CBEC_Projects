...
print("                                         ------------------------------------------------------ ")
print("                                         |                                                     |")
print("                                         |       Monthly TRU Data - BED Advalorem              |")
print("                                         |                                                     |")
print("                                         -------------------------------------------------------")                                 
...
if (FromYear==ToYear and FromMonth==ToMonth):
    FileNm='Data_BED_Advalorem_'+FromMonth+FromYear+'.xlsx'
else:
    FileNm='Data_BED_Advalorem_'+FromMonth+FromYear+ '-'+ ToMonth+ToYear +'.xlsx'
...
sheet2.write('D4:D4','DUTY_ADVLRM',ColumnHead_format)
...
sheet3.write('D4:D4','DUTY_ADVLRM',ColumnHead_format)
...
sheet4.write('D4:D4','DUTY_ADVLRM',ColumnHead_format)
...
sheet5.write('D4:D4','DUTY_ADVLRM',ColumnHead_format)
